...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/.0.27.3@css-loader/index.js!../../node_modules/.6.0.3@sass-loader/lib/loader.js!./main.scss", function() {
			var newContent = require("!!../../node_modules/.0.27.3@css-loader/index.js!../../node_modules/.6.0.3@sass-loader/lib/loader.js!./main.scss");
...
var city = 'shanghai';
fetch('https://wind.waqi.info/nsearch/full/' + city).then(function (res) {
	// console.log(res)
	// console.log(res.json())
	return res.json();
}).then(function (data) {
	console.log(data);
	alert('今日的污染指数为' + data.results[0].s.a);
}).catch(function (res) {
	console.log(res);
});
